package com.acharcitox.formulariotarea;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendFeedback (View view){
        ...
        Intent enviar=new Intent(MainActivity.this,Confirmacion.class);
        enviar.putExtra(Confirmacion.dato_nombre,nombrre_string.trim());
        enviar.putExtra(Confirmacion.dato_fecha,fecha_string.trim());
        enviar.putExtra(Confirmacion.dato_telefono,telefono_string.trim());
        enviar.putExtra(Confirmacion.dato_email,email_string.trim());
        enviar.putExtra(Confirmacion.dato_descripcion,descripcion_string.trim());
